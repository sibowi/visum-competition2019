...
def main():
    ...
    parser.add_argument('-p', '--preds_path', default='./predictions_baseline.csv', metavar='', help='predictions file')
    parser.add_argument('-d', '--imgs_dir', default='./', metavar='', help='dataset directory')
